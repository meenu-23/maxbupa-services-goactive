...
public class FindYourPlanDTO {

    private String mcid;
    private String customerId;
    private FindYourPlanDetailsDTO forms;
    ...
    @JsonProperty("forms")
    public FindYourPlanDetailsDTO getFindYourPlanDetails() {
        return forms;
    }

    @JsonProperty("forms")
    public void setFindYourPlanDetails(FindYourPlanDetailsDTO findYourPlanDetails) {
        this.forms = findYourPlanDetails;
    }

    public FindYourPlanDetailsDTO getForms() {
        return forms;
    }

    public void setForms(FindYourPlanDetailsDTO forms) {
        this.forms = forms;
    }
